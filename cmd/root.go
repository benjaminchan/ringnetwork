...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.ringnetwork.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".ringnetwork" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".ringnetwork")
	}
